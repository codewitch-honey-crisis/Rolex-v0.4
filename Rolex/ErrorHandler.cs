    ...
    internal class ErrorHandler
    {
        ...
        void ListError(LexSpan spn, int num, string key, char lh, char rh)
        {
            ...
            switch (num)
            {
                ...
                case 72: prefix = "Illegal name for start condition "; suffix = "";
                    break;
                case 74: prefix = "Unrecognized \"@options\" directive "; suffix = "";
                    break;
                case 76: prefix = "Unknown character predicate"; suffix = "";
                    break;
                case 83: prefix = "Cannot set /unicode option inconsistently"; suffix = "";
                    break;
                case 84: prefix = "Inconsistent \"@options\" directive "; suffix = "";
                    break;
                case 85: prefix = "Unicode literal too large:"; suffix = "use @options unicode directive";
                    break;
        ...
        internal void ListError(LexSpan spn, int num)
        {
            ...
            switch (num)
            {
                ...
                case 103: message = "Regular expression terminated by end of line"; break;
                case 104: message = "Expecting regular expression or literal string"; break;
        ...
        internal void MakeListing(ScanBuff buff, StreamWriter sWrtr, string name, string version)
        {
            ...
            sWrtr.WriteLine(); 
            ListDivider(sWrtr);
            sWrtr.WriteLine("//  Rolex error listing for lex source file <"
                                                           + name + ">");
            ListDivider(sWrtr);
        ...
        internal void DumpErrorsInMsbuildFormat( ScanBuff buff, TextWriter wrtr ) {
            ...
            // Message prefix
            //
            string location = (buff != null ? buff.FileName : "Rolex");
